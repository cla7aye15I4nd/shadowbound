...
# pragma warning(disable:4595)
 ...
 GC_API  inline void* operator new(size_t size, GC_NS_QUALIFY(GCPlacement) gcp,
...
#ifdef GC_PLACEMENT_DELETE
  GC_API  inline void operator delete(void*, GC_NS_QUALIFY(GCPlacement),
...
# ifdef GC_OPERATOR_NEW_ARRAY
   GC_API   inline void* operator new[](size_t size)
    {
  ...
  GC_API    inline void operator delete[](void* obj) GC_NOEXCEPT
    {
      GC_FREE(obj);
    }
# endif
...
# if __cplusplus > 201103L // C++14
   GC_API   inline void operator delete(void* obj, size_t size) GC_NOEXCEPT {
...
# ifdef GC_DEBUG
    GC_API  inline void* operator new(size_t size, int /* nBlockUse */,
                              const char* szFileName, int nLine)
    {
      void* obj = GC_debug_malloc(size, szFileName, nLine);
      GC_OP_NEW_OOM_CHECK(obj);
      return obj;
    }
# else
...
#ifdef GC_PLACEMENT_DELETE
  GC_API  inline void operator delete(void* p, GC_NS_QUALIFY(GCPlacement) /* gcp */,
                              GC_NS_QUALIFY(GCCleanUpFunc) /* cleanup */,
